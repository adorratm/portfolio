...
const EN_TYPE_ALIASES: Record<string, SocialIconKey> = {
  Email: 'email',
  Website: 'website',
  Twitter: 'x-twitter',
  X: 'x-twitter',
...
/** Eski emoji kayıtları ve platform adından ikon anahtarı çözümler. */
export function resolveSocialIconKey(link: SocialLink): SocialIconKey {
  ...
  const byType = TYPE_TO_ICON[link.type] ?? EN_TYPE_ALIASES[link.type];
